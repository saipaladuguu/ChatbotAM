...
public class Chatbot
{
	...
	/**
	 * The list of memes that are used in the Chatbot. Used in the
	 * memeChecker(String input).
	 */
	...
	public String processText(String userText)
	{
		...
		if (userText != null)
		{
			if (randomChoice == 0)
			{
				...
				{
					processedText = "that is wayyyyyyyy too long to read :D";
				}
				else
				{
	...
	/**
	 * Checks the length of a String for a long String.
	 * 
	 * @param input
	 *            The supplied String object.
